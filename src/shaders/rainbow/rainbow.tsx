...
import vertexShader from "./rainbow.vs?raw";
import fragmentShader from "./rainbow.fs?raw";
import type { ShaderDefinition } from "../../types/shader";

// このシェーダーで使用するuniformの型を定義
export type RainbowUniforms = {
...
export const RainbowShader: ShaderDefinition<RainbowUniforms> = {
  // 頂点シェーダーのコード
  vertexShader,
